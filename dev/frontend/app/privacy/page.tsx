    ...
    <main className="min-h-screen" style={{ backgroundColor: COLORS.pageBg, color: COLORS.text }}>
      ...
      >
        <div className="mx-auto max-w-2xl px-4 py-3 flex items-center gap-3">
          ...
          <div className="text-sm font-semibold">Datenschutz</div>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-2xl px-4 py-4">
        <div className="rounded-2xl border p-4 space-y-3" style={{ borderColor: COLORS.border, backgroundColor: COLORS.panelBg }}>
          ...
          <p className="text-sm leading-relaxed">
            Hier kommt eure Datenschutzerklärung hinein. Für das MVP kann diese Seite zunächst als Platzhalter dienen,
            sollte aber vor Livegang rechtlich sauber befüllt werden.
          </p>
        </div>
      </div>
    </main>
